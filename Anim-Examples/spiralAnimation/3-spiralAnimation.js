...
function GeneratePoints() {
    ...
    for (var theta = 0; theta < 2000; theta +=1) {
        ...
        vertices.push(vec2(.02*angle*Math.cos(angle),
                0.02*angle*Math.sin(angle)));
    }
    return vertices;
}
...
function DrawRoseSpiral() {
	...
	gl.drawArrays(gl.LINE_STRIP, 361, 2000);
...
function render() {
	...
	translate(points[curPoint][0], points[curPoint][1], 0),
	modelViewMatrix
    );
